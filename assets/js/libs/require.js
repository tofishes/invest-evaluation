...
var module = {
  'config': function (options) {
     ...
     for (var name in options.alias) {
        options.paths[name] = options.alias[name];
     };

     require.config.call(this, options);
  },
  'use': function () {
     require.apply(this, arguments);
  },
  'package': function (object, name) { // 模块包装器
    var args = [];
    name && args.push(name);
...
module.plugins = ['plugins/requirejs/text'];
